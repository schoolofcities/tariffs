...
// The bare 'after August 22' / 'before August 22' columns are still emitted by the
// notebooks but are NOT scenario totals — they exclude non-CUSMA exposure entirely.
// Do not point the dropdown at them.
export const TARIFF_NAME_CODES = {
    "All goods subject to tariffs (after Aug 22, 2026)": 'ScenAfter',
    "All goods subject to tariffs (prior to Aug 22, 2026)": 'ScenBefore',
...
export const TARIFF_IMPACT_TEXT = {
    ...
    'ScenBefore_1': "Estimated % and number of businesses directly exposed to all tariffs in effect prior to August 22, 2026",
    'ScenAfter_1': "Estimated % and number of businesses directly exposed to all tariffs in effect after August 22, 2026",
    ...
    'ScenBefore_2': "Estimated % and number of employees (by work location) directly exposed to all tariffs in effect prior to August 22, 2026",
    'ScenAfter_2': "Estimated % and number of employees (by work location) directly exposed to all tariffs in effect after August 22, 2026",
    ...
    'ScenBefore_3': "Estimated % and number of employees (by primary residence) directly exposed to all tariffs in effect prior to August 22, 2026",
    'ScenAfter_3': "Estimated % and number of employees (by primary residence) directly exposed to all tariffs in effect after August 22, 2026",
...
// scenarios now include non-CUSMA exposure, so the old 'before/after August 22'
// breaks (calibrated on ~26.6k businesses nationally vs ~70k+ now) would saturate
// at the top colour almost everywhere. Recompute from CMA percentiles after the
// pipeline re-run and replace these.
//
// NOTE: Section 338_* breaks are ALSO still calibrated against the old broad
// 'before/after August 22' distribution, which was wrong for Section 338 in the
// first place (Section 338 is a narrower subset). Worth recomputing too.
