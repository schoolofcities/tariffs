...
output_path = root / "src" / "routes" / "canada-us-visits-regression" / "assets" / "visitJobsScatterDataRaw.js"
...
js = "export const visitJobsScatterDataRaw = " + json.dumps(records, ensure_ascii=True, indent=2) + ";\n"
