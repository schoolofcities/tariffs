...
def to_js_array(df: pd.DataFrame) -> str:
    ...
    return "export const industryCorrelationsRaw = [\n" + ",\n".join(lines) + "\n];\n"
...
def main() -> None:
    ...
    out_csv       = repo / "analysis" / "outputs" / "dominant_industry_correlations_raw.csv"
    out_js_v2     = repo / "src" / "routes" / "canada-us-visits-regression" / "assets" / "industryCorrelationsRaw.js"
